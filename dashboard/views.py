...
def add_product(request):
    if request.method == 'POST':
        ...
        form = AddProductForm()
    context = {'title':'Añadir producto', 'form':form}
...
def delete_product(request, id):
    ...
    messages.success(request, 'el producto ha sido eliminado!', 'exito')
...
def edit_product(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'El producto ha sido actualizado', 'exito')
            return redirect('dashboard:products')
    else:
...
def orders(request):
    ...
    context = {'title':'Ordenes', 'orders':orders}
...
def order_detail(request, id):
    ...
    context = {'title':'detalles de orden', 'items':items, 'order':order}
...
def dashboard(request):
    ...
    context = {
        'title': 'Panel',
        'total_de_productos': total_products,
